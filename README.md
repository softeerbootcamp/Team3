...
✨ 현재 시간 기준으로 마감되거나 시간이 지난 모임들은 보이지 않느다. <br/>
✨ 사용자들은 최신 순 혹은 마감 임박 순으로 번개 모임들을 확인해 볼 수 있다. </br>
...
✨ 참여 버튼을 통해 해당 번개 모임에 대해 참여할 수 있다. <br/>
✨ 해당 번개 모임의 호스트는 반드시 참여하게 된다. </br>

#### 알림
✨ 현재 유저가 참여하고 있는 글에 대한 알림이 있을 경우, 알림을 받을 수 있다.
✨ e.g. 게시글이 수정되었을 때, 호스트가 마감했을 때 , 댓글이 달렸을 때 <br/>
